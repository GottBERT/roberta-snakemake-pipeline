...
# from model_gottbert import GottbertModel as FairseqRobertaModel
...
if version.parse(fairseq.__version__) < version.parse("0.10.2"):
    raise Exception("requires fairseq >= 0.10.2")
...
def convert_roberta_checkpoint_to_pytorch(
    roberta_checkpoint_path: str, robert_checkpoint_file: str, pytorch_dump_folder_path: str, classification_head: bool
):
    """
    Copy/paste/tweak roberta's weights to our BERT structure.
    """
    roberta = FairseqRobertaModel.from_pretrained(roberta_checkpoint_path, checkpoint_file=robert_checkpoint_file)
...
if __name__ == "__main__":
    ...
    # Required parameters
    parser.add_argument(
        "--robert_checkpoint_file", default="model.pt", type=str, required=False, help="Name of the PyTorch model file."
    )
    parser.add_argument(
